...
def main():
    ...
    remainind_size = total_size - directories["~"].total_size
    min_remove = target_size - remainind_size

    best_dir = min((directory for directory in directories.values() if directory.total_size >= min_remove), key= lambda x: x.total_size)

    print(best_dir.total_size)
